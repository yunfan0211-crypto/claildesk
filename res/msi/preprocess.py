...
g_arpsystemcomponent = {
    ...
    "Contact": {
        "msi": "ARPCONTACT",
        "v": "https://github.com/yunfan0211-crypto/claildesk",
    },
    "HelpLink": {
        "msi": "ARPHELPLINK",
        "v": "https://github.com/yunfan0211-crypto/claildesk/issues/",
    },
    "ReadMe": {
        "msi": "ARPREADME",
        "v": "https://github.com/yunfan0211-crypto/claildesk",
...
def make_parser():
    ...
    parser.add_argument(
        "--build-date", type=str, default="", help="Build date (YYYY-MM-DD HH:MM). If empty, read from exe."
    )
