...
//  https://github.com/rustdesk-org/claildesk_iddDriver/blob/b370aad3f50028b039aad211df60c8051c4a64d6/claildesk_iddDriver/claildesk_iddDriver.inf#LL73C1-L73C40
pub const RUSTDESK_IDD_DEVICE_STRING: &'static str = "claildesk_iddDriver Device\0";
...
pub fn get_cur_device_string() -> &'static str {
    match IDD_IMPL {
        IDD_IMPL_CLAILDESK => RUSTDESK_IDD_DEVICE_STRING,
