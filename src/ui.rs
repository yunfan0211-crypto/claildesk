...
pub fn start(args: &mut [String]) {
    ...
    sciter::set_library("/usr/lib/claildesk/libsciter-gtk.so").ok();
...
#[cfg(windows)]
fn start_tray() -> claildesk_common::ResultType<()> {
...
impl UI {
    ...
    fn test_if_valid_server(&self, host: String) -> String {
        claildesk_common::socket_client::test_if_valid_server(&host)
    }
    ...
    fn is_installed_lower_version(&self) -> bool {
        ...
        #[cfg(windows)]
        {
            ...
            let a = claildesk_common::get_version_number(crate::VERSION);
            let b = claildesk_common::get_version_number(&installed_version);
            return a > b;
        }
    }
    ...
    fn get_new_version(&self) -> String {
        claildesk_common::get_version_from_url(&*SOFTWARE_UPDATE_URL.lock().unwrap())
    }
