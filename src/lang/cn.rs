...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入ClailDesk网络..."),
        ("Enable Service", "允许服务"),
        ("Start Service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于UAC限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将ClailDesk安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予ClailDesk\"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予ClailDesk\"屏幕录制\" 权限。"),
        ("Installing ...", "安装 ..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "為了讓遠程設備通過鼠標或者觸屏控制您的安卓設備，你需要允許ClailDesk使用\"無障礙\"服務。"),
        ...
        ("Account", "账号"),
        ("Quit", "退出"),
        ("doc_mac_permission", "https://claildesk.com/docs/zh-cn/manual/mac/#启用权限"),
        ("Help", "帮助"),
    ].iter().cloned().collect();
}
